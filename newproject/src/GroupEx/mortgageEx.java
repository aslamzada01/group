...
public class mortgageEx {
    ...
    String expactedvalue="Minimum Down Payment: 3.5%";
  //  System.out.println(expactedvalue);
    Thread.sleep(5000);
    String expactedvalue1=driver.findElement(By.xpath("//li[contains(text(),'Minimum Down Payment: 3.5%')]")).getText();
    System.out.println(expactedvalue1);
